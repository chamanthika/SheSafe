...
import 'package:flutter_application_1/Callministry.dart';


class Complaint extends StatelessWidget {
  const Complaint({Key? key});
    ...
    return Stack(
      children: [
        ...
        AlertDialog(
          ...
          content: Text('It will generate a call to the ministry of women and child affairs for assistance '),
          actions: [
            TextButton(
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => Callministry()), // Navigate to CallMinistry.dart
                );
              },
              child: Text(
                'Call',
