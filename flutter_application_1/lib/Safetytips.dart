...
import 'package:flutter_application_1/Selfdefense.dart';
        ...
        children: [
          ...
          Row(
            ...
            children: [
              Stack(
                children: [
                  Image.asset('assets/images/tips.png', height: 78, width: 148), // Image 1
                  Positioned(
                    bottom: 0,
                    left: 0,
                    right: 0,
              ...
              GestureDetector(
                ...
                child: Stack(
                  children: [
                    Image.asset('assets/images/defence.png', height: 78, width: 148), // Image 2
                    Positioned(
                      bottom: 0,
                      left: 0,
                      right: 0,
          ...
          Container(
            ...
            child: Row(
              children: [
                Image.asset('assets/images/travelling.png', height: 100, width: 100), // Left image for container 1
          ...
          Container(
            ...
            child: Row(
              children: [
                Image.asset('assets/images/shopping.png', height: 100, width: 100), // Left image for container 2
                SizedBox(width: 10), // Add spacing between image and container
                Expanded(
                  child: Column(
                    mainAxisAlignment: MainAxisAlignment.start,
          ...
          Container(
            ...
            child: Row(
              children: [
                Image.asset('assets/images/online.png', height: 100, width: 100), // Left image for container 3
                SizedBox(width: 10), // Add spacing between image and container
                Expanded(
                  child: Column(
                    mainAxisAlignment: MainAxisAlignment.start,
